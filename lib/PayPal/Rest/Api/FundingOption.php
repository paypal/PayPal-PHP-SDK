 ...
 *
 * @property string id
 * @property \PayPal\Rest\Api\FundingSource[] funding_sources
 * @property \PayPal\Rest\Api\FundingInstrument backup_funding_instrument
 * @property \PayPal\Rest\Api\CurrencyConversion currency_conversion
 * @property \PayPal\Rest\Api\InstallmentInfo installment_info
...
class FundingOption extends PayPalModel
{
     ...
     *
     * @param \PayPal\Rest\Api\FundingSource[] $funding_sources
     * 
     * @return $this
     */
     ...
     * List of funding sources that contributes to a payment.
     *
     * @return \PayPal\Rest\Api\FundingSource[]
     */
     ...
     *
     * @param \PayPal\Rest\Api\FundingSource $fundingSource
     * @return $this
     */
     ...
     *
     * @param \PayPal\Rest\Api\FundingInstrument $backup_funding_instrument
     * 
     * @return $this
     */
     ...
     *
     * @param \PayPal\Rest\Api\CurrencyConversion $currency_conversion
     * 
     * @return $this
     */
     ...
     * Currency conversion applicable to this funding option.
     *
     * @return \PayPal\Rest\Api\CurrencyConversion
     */
     ...
     *
     * @param \PayPal\Rest\Api\InstallmentInfo $installment_info
     * 
     * @return $this
     */
     ...
     * Installment options available for a funding option.
     *
     * @return \PayPal\Rest\Api\InstallmentInfo
     */
