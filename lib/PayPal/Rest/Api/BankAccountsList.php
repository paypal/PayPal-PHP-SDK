 ...
 * @package PayPal\Api
 *
 * @property \PayPal\Rest\Api\BankAccount[] bank_accounts
 * @property int count
...
class BankAccountsList extends PayPalModel
{
     ...
     * A list of bank account resources
     *
     * @param \PayPal\Rest\Api\BankAccount[] $bank_accounts
     * 
     * @return $this
     */
     ...
     * A list of bank account resources
     *
     * @return \PayPal\Rest\Api\BankAccount[]
     */
     ...
     *
     * @param \PayPal\Rest\Api\BankAccount $bankAccount
     * @return $this
     */
