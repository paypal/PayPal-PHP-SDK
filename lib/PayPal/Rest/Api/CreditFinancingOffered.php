 ...
 * @package PayPal\Api
 *
 * @property \PayPal\Rest\Api\Currency total_cost
 * @property \PayPal\Rest\Api\number term
 * @property \PayPal\Rest\Api\Currency monthly_payment
 * @property \PayPal\Rest\Api\Currency total_interest
...
class CreditFinancingOffered extends PayPalModel
{
     ...
     *
     * @param \PayPal\Rest\Api\Currency $total_cost
     * 
     * @return $this
     */
     ...
     *
     * @param \PayPal\Rest\Api\Currency $monthly_payment
     * 
     * @return $this
     */
     ...
     *
     * @param \PayPal\Rest\Api\Currency $total_interest
     * 
     * @return $this
     */
