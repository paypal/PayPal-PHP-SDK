 ...
 * @package PayPal\Api
 *
 * @property \PayPal\Rest\Api\PayoutSenderBatchHeader sender_batch_header
 * @property \PayPal\Rest\Api\PayoutItem[] items
...
class Payout extends PayPalResourceModel
{
     ...
     *
     * @param \PayPal\Rest\Api\PayoutSenderBatchHeader $sender_batch_header
     *
     * @return $this
     */
     ...
     * The original batch header as provided by the payment sender.
     *
     * @return \PayPal\Rest\Api\PayoutSenderBatchHeader
     */
     ...
     *
     * @param \PayPal\Rest\Api\PayoutItem[] $items
     *
     * @return $this
     */
     ...
     * An array of payout items (that is, a set of individual payouts).
     *
     * @return \PayPal\Rest\Api\PayoutItem[]
     */
     ...
     *
     * @param \PayPal\Rest\Api\PayoutItem $payoutItem
     * @return $this
     */
