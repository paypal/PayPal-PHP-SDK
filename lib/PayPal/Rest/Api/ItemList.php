 ...
 * @package PayPal\Api
 *
 * @property \PayPal\Rest\Api\Item[]          items
 * @property \PayPal\Rest\Api\ShippingAddress shipping_address
...
class ItemList extends PayPalModel
{
     ...
     * List of items.
     *
     * @param \PayPal\Rest\Api\Item[] $items
     *
     * @return $this
     */
     ...
     *
     * @param \PayPal\Rest\Api\Item $item
     * @return $this
     */
     ...
     *
     * @param \PayPal\Rest\Api\ShippingAddress $shipping_address
     *
     * @return $this
     */
     ...
     * Shipping address, if different than the payer address.
     *
     * @return \PayPal\Rest\Api\ShippingAddress
     */
