 ...
 * @property \PayPal\Rest\Api\InstallmentOption[] installment_options
 */
class InstallmentInfo extends PayPalModel
{
     ...
     *
     * @param \PayPal\Rest\Api\InstallmentOption[] $installment_options
     * 
     * @return $this
     */
     ...
     * List of available installment options and the cost associated with each one.
     *
     * @return \PayPal\Rest\Api\InstallmentOption[]
     */
     ...
     *
     * @param \PayPal\Rest\Api\InstallmentOption $installmentOption
     * @return $this
     */
