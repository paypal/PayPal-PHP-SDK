...
use PayPal\Rest\Common\PayPalResourceModel;
use PayPal\Rest\ApiContext;
use PayPal\Rest\Transport\PayPalRestCall;
use PayPal\Rest\Validation\ArgumentValidator;
 ...
 * @property \PayPal\Rest\Api\MerchantInfo merchant_info
 * @property \PayPal\Rest\Api\BillingInfo[] billing_info
 * @property \PayPal\Rest\Api\ShippingInfo shipping_info
 * @property \PayPal\Rest\Api\InvoiceItem[] items
 * @property string invoice_date
 * @property \PayPal\Rest\Api\PaymentTerm payment_term
 * @property \PayPal\Rest\Api\Cost discount
 * @property \PayPal\Rest\Api\ShippingCost shipping_cost
 * @property \PayPal\Rest\Api\CustomAmount custom
 ...
 * @property \PayPal\Rest\Api\Currency total_amount
 * @property \PayPal\Rest\Api\PaymentDetail[] payments
 * @property \PayPal\Rest\Api\RefundDetail[] refunds
 * @property \PayPal\Rest\Api\Metadata metadata
...
class Invoice extends PayPalResourceModel
{
     ...
     *
     * @param \PayPal\Rest\Api\MerchantInfo $merchant_info
     * 
     * @return $this
     */
     ...
     * Information about the merchant who is sending the invoice.
     *
     * @return \PayPal\Rest\Api\MerchantInfo
     */
     ...
     *
     * @param \PayPal\Rest\Api\BillingInfo[] $billing_info
     * 
     * @return $this
     */
     ...
     * Email address of invoice recipient (required) and optional billing information. (Note: We currently only allow one recipient).
     *
     * @return \PayPal\Rest\Api\BillingInfo[]
     */
     ...
     *
     * @param \PayPal\Rest\Api\BillingInfo $billingInfo
     * @return $this
     */
     ...
     *
     * @param \PayPal\Rest\Api\ShippingInfo $shipping_info
     * 
     * @return $this
     */
     ...
     * Shipping information for entities to whom items are being shipped.
     *
     * @return \PayPal\Rest\Api\ShippingInfo
     */
     ...
     *
     * @param \PayPal\Rest\Api\InvoiceItem[] $items
     * 
     * @return $this
     */
     ...
     * List of items included in the invoice. 100 items max per invoice.
     *
     * @return \PayPal\Rest\Api\InvoiceItem[]
     */
     ...
     *
     * @param \PayPal\Rest\Api\InvoiceItem $invoiceItem
     * @return $this
     */
     ...
     *
     * @param \PayPal\Rest\Api\PaymentTerm $payment_term
     * 
     * @return $this
     */
     ...
     * Optional field to pass payment deadline for the invoice. Either term_type or due_date can be passed, but not both.
     *
     * @return \PayPal\Rest\Api\PaymentTerm
     */
     ...
     *
     * @param \PayPal\Rest\Api\ShippingCost $shipping_cost
     * 
     * @return $this
     */
     ...
     * Shipping cost in percent or amount.
     *
     * @return \PayPal\Rest\Api\ShippingCost
     */
     ...
     *
     * @param \PayPal\Rest\Api\CustomAmount $custom
     * 
     * @return $this
     */
     ...
     * Custom amount applied on an invoice. If a label is included then the amount cannot be empty.
     *
     * @return \PayPal\Rest\Api\CustomAmount
     */
     ...
     *
     * @param \PayPal\Rest\Api\Currency $total_amount
     * 
     * @return $this
     */
     ...
     *
     * @param \PayPal\Rest\Api\PaymentDetail[] $payments
     * 
     * @return $this
     */
     ...
     * List of payment details for the invoice.
     *
     * @return \PayPal\Rest\Api\PaymentDetail[]
     */
     ...
     *
     * @param \PayPal\Rest\Api\PaymentDetail $paymentDetail
     * @return $this
     */
     ...
     *
     * @param \PayPal\Rest\Api\RefundDetail[] $refunds
     * 
     * @return $this
     */
     ...
     * List of refund details for the invoice.
     *
     * @return \PayPal\Rest\Api\RefundDetail[]
     */
     ...
     *
     * @param \PayPal\Rest\Api\RefundDetail $refundDetail
     * @return $this
     */
     ...
     *
     * @param \PayPal\Rest\Api\Metadata $metadata
     * 
     * @return $this
     */
     ...
     * Audit information for the invoice.
     *
     * @return \PayPal\Rest\Api\Metadata
     */
