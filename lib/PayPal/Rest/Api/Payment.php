...
use PayPal\Rest\Core\PayPalConstants;
 ...
 * @property \PayPal\Rest\Api\Payer                   payer
 * @property \PayPal\Rest\Api\PotentialPayerInfo      potential_payer_info
 * @property \PayPal\Rest\Api\Payee                   payee
 * @property \PayPal\Rest\Api\Transaction[]           transactions
 * @property string[] billing_agreement_tokens
 * @property \PayPal\Rest\Api\PaymentInstruction      payment_instruction
 * @property string                              state
 * @property string                              experience_profile_id
 * @property string                              note_to_payer
 * @property \PayPal\Rest\Api\RedirectUrls            redirect_urls
...
class Payment extends PayPalResourceModel
{
     ...
     *
     * @param \PayPal\Rest\Api\Payer $payer
     *
     * @return $this
     */
     ...
     *
     * @param \PayPal\Rest\Api\PotentialPayerInfo $potential_payer_info
     *
     * @return $this
     */
     ...
     * Information that the merchant knows about the payer.  This information is not definitive and only serves as a hint to the UI or any pre-processing logic.
     *
     * @return \PayPal\Rest\Api\PotentialPayerInfo
     */
     ...
     *
     * @param \PayPal\Rest\Api\Payee $payee
     *
     * @return $this
     */
     ...
     *
     * @param \PayPal\Rest\Api\Transaction[] $transactions
     *
     * @return $this
     */
     ...
     * Transactional details including the amount and item details.
     *
     * @return \PayPal\Rest\Api\Transaction[]
     */
     ...
     *
     * @param \PayPal\Rest\Api\Transaction $transaction
     * @return $this
     */
     ...
     *
     * @deprecated Not publicly available
     * @param \PayPal\Rest\Api\Error[] $failed_transactions
     *
     * @return $this
     */
     ...
     *
     * @deprecated Not publicly available
     * @param \PayPal\Rest\Api\Error $error
     * @return $this
     */
     ...
     *
     * @deprecated Not publicly available
     * @param \PayPal\Rest\Api\CreditFinancingOffered $credit_financing_offered
     *
     * @return $this
     */
     ...
     *
     * @deprecated Not publicly available
     * @return \PayPal\Rest\Api\CreditFinancingOffered
     */
     ...
     *
     * @param \PayPal\Rest\Api\PaymentInstruction $payment_instruction
     *
     * @return $this
     */
     ...
     * Instructions for the payer to complete this payment.
     *
     * @return \PayPal\Rest\Api\PaymentInstruction
     */
     ...
     *
     * @param \PayPal\Rest\Api\RedirectUrls $redirect_urls
     *
     * @return $this
     */
     ...
     * Set of redirect URLs you provide only for PayPal-based payments.
     *
     * @return \PayPal\Rest\Api\RedirectUrls
     */
