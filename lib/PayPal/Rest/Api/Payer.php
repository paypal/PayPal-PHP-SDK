 ...
 * @property \PayPal\Rest\Api\FundingInstrument[] funding_instruments
 * @property string                          funding_option_id
 * @property \PayPal\Rest\Api\PayerInfo           payer_info
 */
class Payer extends PayPalModel
{
     ...
     *
     * @param \PayPal\Rest\Api\FundingInstrument[] $funding_instruments
     *
     * @return $this
     */
     ...
     *
     * @param \PayPal\Rest\Api\FundingInstrument $fundingInstrument
     * @return $this
     */
     ...
     *
     * @deprecated Not publicly available
     * @param \PayPal\Rest\Api\FundingOption $funding_option
     *
     * @return $this
     */
     ...
     *
     * @deprecated Not publicly available
     * @return \PayPal\Rest\Api\FundingOption
     */
     ...
     *
     * @deprecated Not publicly available
     * @param \PayPal\Rest\Api\FundingOption $related_funding_option
     *
     * @return $this
     */
     ...
     *
     * @param \PayPal\Rest\Api\PayerInfo $payer_info
     *
     * @return $this
     */
     ...
     * Information related to the Payer.
     *
     * @return \PayPal\Rest\Api\PayerInfo
     */
