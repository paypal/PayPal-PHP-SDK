...
use PayPal\Rest\Common\PayPalUserAgent;
...
use PayPal\Rest\Exception\PayPalInvalidCredentialException;
use PayPal\Rest\Exception\PayPalMissingCredentialException;
...
class OauthHandler implements IPayPalHandler
{
     ...
     * @throws \PayPal\Rest\Exception\PayPalConfigurationException
     */
