...
class OAuthTokenCredential extends PayPalResourceModel
{
     ...
     */
    public static $AUTH_HANDLER = 'PayPal\Rest\Handler\OauthHandler';
     ...
     * @throws \PayPal\Rest\Exception\PayPalConnectionException
     */
