...
def validate_version_match()
  if constant_version() != @current_release.version
    Printer.fail("lib/PayPal/Core/Version.php version #{constant_version} does not match changelog version #{@current_release.version}.")
    abort()
  end
  Printer.success("lib/PayPal/Core/Version.php version #{constant_version} matches latest changelog version.")
end
...
def constant_version()
  File.open("lib/PayPal/Core/Version.php", 'r') do |f|
    f.each_line do |line|
